declare namespace Jymfony.Component.Messenger.Handler {
    ...
    export type MessageSubscription = Newable | string | [ Newable | string, MessageSubscriptionOptions ];

    /**
     * Handlers can implement this interface to handle multiple messages.
     */
    export class MessageSubscriberInterface extends MessageHandlerInterface.definition {
        /**
         ...
         */
        static getHandledMessages(): Iterator<MessageSubscription>;
    }
}
