 ...
 */
class ConstraintViolationInterface {
    /**
     ...
     *
     * @returns {string} The raw violation message
     */
    get messageTemplate() { }
     ...
     *
     * @returns {Object.<string, string>} a possibly empty list of parameters indexed by the names
     ...
     *
     * @returns {int|null} The number to use to pluralize of the message
     */
    get plural() { }
     ...
     *
     * @returns {string} The property path indicates how the validator reached
...
export default getInterface(ConstraintViolationInterface);
