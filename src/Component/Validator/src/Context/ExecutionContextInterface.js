...
class ExecutionContextInterface {
     ...
     * @param {Object.<string, *>} params The parameters substituted in the error message
     */
    addViolation(message, params = {}) { }
     ...
     *
     * @param {string} message The error message
     * @param {Object.<string, string>} parameters The parameters substituted in the error message
     *
     * @returns {Jymfony.Component.Validator.Violation.ConstraintViolationBuilderInterface} The violation builder
     */
     ...
     *
     * @returns {*|null} The currently validated object or null
     */
    get object() { }
     ...
     * @param {Jymfony.Contracts.Metadata.MetadataInterface|null} metadata The validation metadata
     ...
     *
     * @param {Jymfony.Component.Validator.Constraint} constraint The validated constraint
     *
     * @internal Used by the validator engine. Should not be called by user code.
     */
     ...
     * @param {string} groupHash The group's name or hash, if it is group sequence
     *
     * @internal Used by the validator engine. Should not be called by user code.
     */
     ...
     *                          sequence
     *
     * @returns {boolean} Whether the object was already validated for that group
     *
     * @internal Used by the validator engine. Should not be called by user code.
     */
     ...
     *
     * @returns {Jymfony.Component.Validator.ConstraintViolationListInterface} The constraint violation list
     */
    get violations() { }
     ...
     * null.
     *
     * @returns {Jymfony.Contracts.Metadata.MetadataInterface|null} the metadata of the currently validated value
     */
    get metadata() { }
     ...
     *
     * @returns {string} The current validation group
     */
    get group() { }
     ...
     *
     * @returns {string|null} The class name or null, if no class name could be found
     */
    get className() { }
     ...
     * current node, this method returns null.
     *
     * @returns {string|null} The property name or null, if no property name could be found
     */
    get propertyName() { }
...
export default getInterface(ExecutionContextInterface);
