declare namespace Jymfony.Contracts.HttpClient {
    export type HttpClientInfo = Record<string, any>;
    ...
    export class ResponseInterface {
         ...
         *
         * @param [Throw = true] Whether an exception should be thrown on 3/4/5xx status codes
         *
         * @returns The headers of the response keyed by header names in lowercase
         *
         * @throws {Jymfony.Contracts.HttpClient.Exception.TransportException} When a network error occurs
